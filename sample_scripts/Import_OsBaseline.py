...
body["OSBaselineDescription"] = args.Name
...
try:
    response = REDFISH_OBJ.post("/redfish/v1/JobService/Actions/Oem/Hpe/HpeWfmJobServiceExt.ImportOSBaselineJobs", body=body)
except:
    print("POST request to /redfish/v1/JobService/Actions/Oem/Hpe/HpeWfmJobServiceExt.ImportOSBaselineJobs failed\n")
    REDFISH_OBJ.logout()
    exit()

errMessage = ""
if response.status != 202:
    sys.stdout.write("Unable to import os baseline\n")
...
sys.stdout.write("Import os baseline job has been created successfully\n")
