...
# Check for the multiple occurance of same argument, if so raise exception and return
...
uri = "/redfish/v1/Managers/iLOAmplifier/BaselineService/Baselines/" + str(args.BaselineId)
try:
...
if response.status != 200:
    sys.stdout.write("Failed to delete baseline\n")
