...
# Get all imported baseline information
...
uri = "/redfish/v1/Managers/iLOAmplifier/BaselineService/Baselines"
try:
...
if response.status != 200:
    sys.stdout.write("Failed to get baseline information\n")
...
if Baseline_Count > 0:
  ...
  for Baseline in Baseline_Info:
      sys.stdout.write("BaselineId=%s, SPPImage=%s\n" % (Baseline["Id"], Baseline["Name"]))
else:
